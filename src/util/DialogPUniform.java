 ...
 * @author thiago
 */
public class DialogPUniform extends javax.swing.JDialog {

    /**
     * Creates new form DialogPUniform
     */
    public DialogPUniform(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogPUniform.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogPUniform dialog = new DialogPUniform(new javax.swing.JFrame(), true);
